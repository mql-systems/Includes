...
//    WIN_THEME_COLOR_BTNHILIGHT = 20,
    ...
    WIN_THEME_COLOR_MENUHILIGHT = 29,             // The color used to highlight menu items when the menu appears as a flat menu (see SystemParametersInfo). The highlighted menu item is outlined with COLOR_HIGHLIGHT. Windows&nbsp;2000, Windows 10 or greater:&nbsp;&nbsp;</b>This value is not supported.
    WIN_THEME_COLOR_MENUBAR = 30,                 // The background color for the menu bar when menus appear as flat menus (see SystemParametersInfo). However, COLOR_MENU continues to specify the background color of the menu popup. Windows&nbsp;2000, Windows 10 or greater:&nbsp;&nbsp;</b>This value is not supported.
};